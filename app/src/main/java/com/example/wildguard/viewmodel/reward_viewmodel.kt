...
class RewardViewModel : ViewModel() {
    ...
    var currentPoint by mutableIntStateOf(5000)
        private set
    ...
    var showReaction by mutableStateOf(false)
        private set

    var currentReaction by mutableStateOf(ReactionType.SMILE)
        private set
    ...
    private fun refreshAchievements() {
        _achievements.indices.forEach { index ->
            ...
            if (achievement.type == AchievementType.NULL) {
                return@forEach
            }
